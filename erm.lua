    ...
    if Workspace:FindFirstChild("Rendered") then
        ...
        if isfile("Moonx/SelectedRifts.txt") then
            ...
            if SelectedRiftsRaw == "none" then         
                print("SIMPLE SHIT: No rift selected")
            ...
            if Found == false then
                if NewServer == game.JobId then
                    print("SIMPLE SHIT: Rift not found, staying in the current server.")
                    (loadstring or load)(game:HttpGet("https://raw.githubusercontent.com/MateoDev2024/MoonX/refs/heads/main/Loader.lua"))()
                    return
                else
                    print("SIMPLE SHIT: Teleporting to new server: " .. NewServer)
            ...
            print("SIMPLE SHIT: No selected rifts file found")
            (loadstring or load)(game:HttpGet("https://raw.githubusercontent.com/MateoDev2024/MoonX/refs/heads/main/Loader.lua"))()
            return
        end
    else
        print("SIMPLE SHIT: Rendered workspace not found")
        (loadstring or load)(game:HttpGet("https://raw.githubusercontent.com/MateoDev2024/MoonX/refs/heads/main/Loader.lua"))()
        return 
    end
]]
